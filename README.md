...
| **GSI**| Irene Farah Rivadeneyra / [irenef@berkeley.edu](mailto:irenef@berkeley.edu) <br>Office hours: Thu 2-4pm / sign-up [here](https://calendly.com/irenefarah/15min)|
...
If you have a disability, or think you may have a disability, you can work with the Disabled Students&#39; Program (DSP) to request an official accommodation. The Disabled Students&#39; Program (DSP) is the campus office responsible for authorizing disability-related academic accommodations, in cooperation with the students themselves and their instructors. You can find more information about DSP, including contact information and the application process here:[dsp.berkeley.edu](https://dsp.berkeley.edu/). If you have already been approved for accommodations through DSP, please meet with me so we can develop an implementation plan together.
...
**Mon, Jan 31 Intro to Python with Jupyter Notebooks**
...
**Mon, Feb 7 Data Analysis in Python**
...
**Mon, Feb 14 💘 Data Visualization - Pt. I**
...
**Wed, Feb 16 Data Visualization - Pt. II**
...
**Mon, Feb 21** _NO CLASS__(President&#39;s Day)_

**MODULE 4: OPEN DATA AND APIs**

**Wed, Feb 23 Intro to APIs**
...
**Wed, Mar 2 Intro to Geospatial Data Analysis**
...
**Mon, Mar 7 FOSS tools for Geospatial Data Analysis**
...
**Wed, Mar 9 Intro to Network Analysis**
...
**Mon, Mar 28 Building Interactive Maps**
...
**Mon, Apr 4 Statistical Analysis**
...
**Wed, Apr 6 Advanced Stats/Machine Learning in Python**
...
**Mon, Apr 11 Causal Inference Methods in Urban Science**
